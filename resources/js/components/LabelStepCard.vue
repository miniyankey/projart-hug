...
<template>
    <div
        class="relative overflow-hidden p-6 transition-transform hover:-translate-y-1"
        :style="cardStyle"
    >
        <!-- Rivets coins -->
        <div
            class="absolute top-2 left-2 h-2.5 w-2.5"
            :style="{ backgroundColor: palette.rivetLight }"
        />
        <div
        ...
        <div
            ...
            :style="{ backgroundColor: palette.rivetDark }"
        />
        <div
            class="absolute right-2 bottom-2 h-2.5 w-2.5"
            :style="{ backgroundColor: palette.rivetDark }"
        />

        <!-- Contenu -->
        <p
            class="font-pixel text-[0.6rem] tracking-widest uppercase"
            style="opacity: 1"
        >
            ETAPE {{ step }}
        </p>
        <h3 class="mt-2 font-pixel text-lg leading-snug uppercase">
            {{ title }}
        </h3>
