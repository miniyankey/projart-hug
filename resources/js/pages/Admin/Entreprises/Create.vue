...
<template>
    <AdminLayout :title="t('admin.entreprises.create.title')">
        <template #subtitle>{{ t('admin.entreprises.create.subtitle') }}</template>
        ...
        <div
            class="grid grid-cols-1 gap-8 xl:grid-cols-[minmax(0,1fr)_340px]"
        >
            ...
            >
                <FormField
                    ...
                    :placeholder="t('admin.entreprises.create.name_placeholder')"
            ...
            >
                <FormField
                    ...
                    :placeholder="t('admin.entreprises.create.contact_name_placeholder')"
                    :error="form.errors.contact_name"
                />
                <FormField
                    v-model="form.contact_phone"
                    :label="t('admin.entreprises.create.contact_phone')"
                    :placeholder="t('admin.entreprises.create.contact_phone_placeholder')"
                ...
                <FormField
                    ...
                    :placeholder="t('admin.entreprises.create.email_placeholder')"
            ...
            >
                <FormField
                    ...
                    :placeholder="t('admin.entreprises.create.street_placeholder')"
                ...
                <FormField
                    ...
                    :placeholder="t('admin.entreprises.create.postal_code_placeholder')"
                ...
                <FormField
                    ...
                    :placeholder="t('admin.entreprises.create.city_placeholder')"
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="flex items-center gap-2">
                                ...
                                >
                                    <Upload class="size-4" />
                                    {{ t('admin.entreprises.create.logo_choose') }}
                                </Button>
                                <button
                                    v-if="logoPreview"
                                    type="button"
                                ...
                                >
                                    <X class="size-4" />
                                    {{ t('admin.entreprises.create.logo_remove') }}
                                </button>
                            </div>
